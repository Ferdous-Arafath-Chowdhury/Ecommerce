	...
	<div class="container">
		<div class="contact-box">
		 ...
		 <input type="text" class="field" name="des" placeholder="Description" required>
				<input type="text" class="field" name="cat" placeholder="Category" required>
				<input type="text" class="field" name="price" placeholder="Price" required>
                <input type="text" class="field" name="discount" placeholder="Discount ID" required>
                <input type="text" class="field" name="qnt" placeholder="Quantity" required>
                <input type="text" class="field" name="venid" placeholder="Vendor ID" required>
                <input type="text" class="field" name="brand" placeholder="Brand" required>
